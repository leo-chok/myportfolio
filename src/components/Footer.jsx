...
function Footer() {
  ...
  return (
    <footer style={footerStyle}>
      ...
      <div>
          <a href={linkedInUrl} target="_blank" rel="noopener noreferrer" style={linkStyle} title="LinkedIn">
              <i className="nes-icon linkedin is-medium"></i> {/* Icône un peu plus grande */}
          </a>
          <a href={githubUrl} target="_blank" rel="noopener noreferrer" style={linkStyle} title="GitHub">
              <i className="nes-icon github is-medium"></i> {/* Icône un peu plus grande */}
          </a>
