...
function Skills() {
  ...
  return (
    <section
      ref={ref}
      className={`nes-container is-rounded is-dark with-title fade-in-section ${
        inView ? "is-visible" : ""
      }`}
        ...
        <div key={category} style={{ marginBottom: "1.5rem" }}>
          ...
          <div
            style={{
              ...
              flexWrap: "wrap",
              gap: "1rem 2rem" /* Espace vertical / horizontal */,
            }}
          >
            {skills.map((skill, skillIndex) => {
              // Détermine la couleur du badge en boucle
              const colorClass =
                badgeColors[(categoryIndex + skillIndex) % badgeColors.length];
